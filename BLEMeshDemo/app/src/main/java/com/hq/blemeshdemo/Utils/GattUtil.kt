...
class UUID {
    companion object {
        ...
        val PROXY_IN_CHARACTERISTIC_UUID: UUID = UUID.fromString("00002add-0000-1000-8000-00805f9b34fb")
        val PROXY_OUT_CHARACTERISTIC_UUID: UUID = UUID.fromString("00002ade-0000-1000-8000-00805f9b34fb")
